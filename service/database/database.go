...
type AppDatabase interface {
	...
	// social
	GetFollowing(targetId string, requesterId string) ([]models.UserResponse, bool, error)
	GetFollowers(targetId string, requesterId string) ([]models.UserResponse, bool, error)
